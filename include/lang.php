...
$Msg['pt']['SiteTitle']          = "Mapatona Postos do Acessa no OpenStreetMap";
$Msg['pt']['ErrSessStart']       = 'Erro ao iniciar sessão de forma segura';
$Msg['pt']['IntroTitle']         = "Vamos colocar os postos do Acessa SP no mapa do OpenStreetMap? Esta ferramenta te ajudará a mapear e acompanhar o andamento, principalmente se você não tem intimidade com mapas ou quer começar agora.";
